...
class Dataset(object):
    ...
    def _data_processing(self):
        ...
        print("build_feat_name_lislt:", self.feat_name_list)
        if self.benchmark_filename_list is None:
            print("self.benchmark_filename_list", self.benchmark_filename_list)
            self._data_filtering()
            print("完成_data_filtering")
    ...
    def _data_filtering(self):
        ...
        print("完成_filter_nan_user_or_item")
    ...
    def _load_inter_feat(self, token, dataset_path):
        ...
        if self.benchmark_filename_list is None:
            ...
            print("after self._load_feat:", inter_feat)
    ...
    def _filter_nan_user_or_item(self):
        ...
        """
        print("self.uid_field", self.uid_field)
        print("self.iid_field", self.iid_field)
        for field, name in zip([self.uid_field, self.iid_field], ['user', 'item']):
            ...
            if field is not None:
                ...
                print("self.inter_feat.index", self.inter_feat.index)
